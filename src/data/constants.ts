...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    startDate: "Jun 2025",
    endDate: "Present",
    title: "Lead Systems & Anti-Cheat Developer",
    company: "Stitch Security Core",
    description: [
      "Created and distributed Stitch Analyzer, a dual-sided Minecraft cheat scanning launcher.",
      "Developed a client-side scanning daemon that performs process memory scans and signs runtime binaries.",
      "Designed server-side Java NMS packet interceptors to capture combat, movement, and click macro events.",
    ],
    skills: [
      SkillNames.TS,
      SkillNames.JS,
  ...
  },
  {
    ...
    startDate: "Jan 2025",
    endDate: "Dec 2025",
    title: "Freelance Full-Stack & Bot Systems Developer",
    company: "Freelance",
    description: [
      "Designed, developed, and hosted over 100+ custom Discord bots for game servers and communities.",
      "Implemented AutoTierList automated ranking engine syncing discord roles with game server states.",
      "Constructed Tebex store checkouts, web admin dashboards, and custom backend APIs.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.HTML,
